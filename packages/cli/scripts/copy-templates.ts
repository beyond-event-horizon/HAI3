...
const config = {
  ...
  // - package.json (needs project name and conditional dependencies)
  // - hai3.config.json (needs config options)
  // - Root config wrappers (.eslintrc.cjs, .dependency-cruiser.cjs, tsconfig.json)
  //
  // Files copied from source (minimal transformation in project.ts if needed):
  // - src/main.tsx - may remove @hai3/uikit/styles import if uikit='custom'
};
