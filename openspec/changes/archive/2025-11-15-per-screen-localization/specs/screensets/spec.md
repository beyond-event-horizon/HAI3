...
Screenset configuration and registration, including translation setup.
...
- **i18n-loading**: Provides the `registerTranslationsFromDirectory()` helper
- **screen-translation**: Defines how screens use their colocated translations
- **screen-rendering**: (existing) Defines lazy-loading of screen components
