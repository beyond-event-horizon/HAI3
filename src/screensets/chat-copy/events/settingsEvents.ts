...
export enum SettingsEvents {
  ModelChanged = `${CHAT_COPY_SCREENSET_ID}/${DOMAIN_ID}/modelChanged`,
  ContextAdded = `${CHAT_COPY_SCREENSET_ID}/${DOMAIN_ID}/contextAdded`,
  ContextRemoved = `${CHAT_COPY_SCREENSET_ID}/${DOMAIN_ID}/contextRemoved`,
}
