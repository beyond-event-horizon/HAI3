...
export enum ComposerEvents {
  FileAttached = `${CHAT_COPY_SCREENSET_ID}/${DOMAIN_ID}/fileAttached`,
  FileRemoved = `${CHAT_COPY_SCREENSET_ID}/${DOMAIN_ID}/fileRemoved`,
  InputValueChanged = `${CHAT_COPY_SCREENSET_ID}/${DOMAIN_ID}/inputValueChanged`,
}
