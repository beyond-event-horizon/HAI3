...
export enum DataEvents {
  FetchStarted = `${CHAT_COPY_SCREENSET_ID}/${DOMAIN_ID}/fetchStarted`,
  FetchSucceeded = `${CHAT_COPY_SCREENSET_ID}/${DOMAIN_ID}/fetchSucceeded`,
  FetchFailed = `${CHAT_COPY_SCREENSET_ID}/${DOMAIN_ID}/fetchFailed`,
}
