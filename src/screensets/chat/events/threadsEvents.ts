...
export enum ThreadsEvents {
  ...
  DraftCreated = `${CHAT_SCREENSET_ID}/${DOMAIN_ID}/draftCreated`,
  Created = `${CHAT_SCREENSET_ID}/${DOMAIN_ID}/created`,
  Deleted = `${CHAT_SCREENSET_ID}/${DOMAIN_ID}/deleted`,
  TitleUpdated = `${CHAT_SCREENSET_ID}/${DOMAIN_ID}/titleUpdated`,
  Reordered = `${CHAT_SCREENSET_ID}/${DOMAIN_ID}/reordered`,
  TemporaryToggled = `${CHAT_SCREENSET_ID}/${DOMAIN_ID}/temporaryToggled`,
}
